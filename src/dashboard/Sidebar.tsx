...
import { Menu, X, LayoutDashboard, Users, ShoppingCart, Settings, BarChart3, Bell } from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-white/20">
            <div className="flex items-center gap-3">
              ...
              <span className={`text-white font-bold text-xl whitespace-nowrap transition-all duration-300 
                ${!isOpen && 'lg:opacity-0'}`}>
                Glass Admin
              </span>
            </div>
